...
export const generateMetadata = ({ params }) => {
  ...
  return {
    title: `Hot Movie Russian Sex Gulf Sex Iranian Sex Video | hexmy`,
    description: `Sunny Leone sex video, sexx, american super sex movie, sex video, sex stories, aunt sex, super movie, sex video, iranian sex, xxx video, foreign sex hexmy`,
    alternates: {
      canonical: `https://hexmy.com/hijabi/${currentPage}`,
    },
    robots: {
      index: true,
      follow: true,
...
export default async function HijabiPage({ params }) {
  ...
  try {
    const response = await fetch(
      `${apiUrl}/getHijabi?page=${page}&limit=${itemsPerPage}`,
